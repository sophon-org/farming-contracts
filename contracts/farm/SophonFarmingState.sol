...
contract SophonFarmingState {
    ...
    struct PoolInfo {
        ...
        uint256 enabledDate; // anticipated date the pool is enabled (if set to a value already in the past, the pool is immediately enabled)
    ...
    mapping(address => mapping(address => bool inWhitelist)) public whitelist;
}
